...
typedef struct kong_builtin_types {
	type_id void_type;
	type_id float_type;
	type_id float2_type;
	type_id float3_type;
	type_id float4_type;
	type_id float2x2_type;
	type_id float3x2_type;
	type_id float2x3_type;
	type_id float4x2_type;
	type_id float2x4_type;
	type_id float3x3_type;
	type_id float4x3_type;
	type_id float3x4_type;
	type_id float4x4_type;
	type_id int_type;
	type_id int2_type;
	type_id int3_type;
	type_id int4_type;
...
#define void_id         (kong_active_builtin_types()->void_type)
#define float_id        (kong_active_builtin_types()->float_type)
#define float2_id       (kong_active_builtin_types()->float2_type)
#define float3_id       (kong_active_builtin_types()->float3_type)
#define float4_id       (kong_active_builtin_types()->float4_type)
#define float2x2_id     (kong_active_builtin_types()->float2x2_type)
#define float3x2_id     (kong_active_builtin_types()->float3x2_type)
#define float2x3_id     (kong_active_builtin_types()->float2x3_type)
#define float4x2_id     (kong_active_builtin_types()->float4x2_type)
#define float2x4_id     (kong_active_builtin_types()->float2x4_type)
#define float3x3_id     (kong_active_builtin_types()->float3x3_type)
#define float4x3_id     (kong_active_builtin_types()->float4x3_type)
#define float3x4_id     (kong_active_builtin_types()->float3x4_type)
#define float4x4_id     (kong_active_builtin_types()->float4x4_type)
#define int_id          (kong_active_builtin_types()->int_type)
#define int2_id         (kong_active_builtin_types()->int2_type)
#define int3_id         (kong_active_builtin_types()->int3_type)
#define int4_id         (kong_active_builtin_types()->int4_type)
#define uint_id         (kong_active_builtin_types()->uint_type)
#define uint2_id        (kong_active_builtin_types()->uint2_type)
#define uint3_id        (kong_active_builtin_types()->uint3_type)
#define uint4_id        (kong_active_builtin_types()->uint4_type)
#define bool_id         (kong_active_builtin_types()->bool_type)
#define bool2_id        (kong_active_builtin_types()->bool2_type)
#define bool3_id        (kong_active_builtin_types()->bool3_type)
#define bool4_id        (kong_active_builtin_types()->bool4_type)
#define sampler_type_id (kong_active_builtin_types()->sampler_type)
#define ray_type_id     (kong_active_builtin_types()->ray_type)
#define bvh_type_id     (kong_active_builtin_types()->bvh_type)
