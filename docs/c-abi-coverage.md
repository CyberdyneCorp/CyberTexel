...
texture-set, colour-management, read-only mesh-ingest and bounded in-memory PNG
decode and encode operations, but 218 runtime requirements still lack C entry
points. Mesh handles own allocator-routed
