...
- [x] 18.2 Desktop WGSL and mobile MSL reference hosts in slice A, built in CI, run on named devices with residency-traffic and input-to-visible instrumentation
...
- [x] 18.5 After the macOS, Linux and iOS release scope and groups 1–20 pass, archive this change and fold its requirements into `openspec/specs/`
- [x] 18.6 Transfer Windows and Android packages, smoke tests and the Android device matrix to the active `windows-android-release` follow-up change
